...
Lampa.SettingsApi.addParam({
    ...
    onChange: function (value) {
     if (value == 'jackett') Lampa.Storage.set('jackett_url', 'https://jct.liporik.ru/jackett')&Lampa.Storage.set('jackett_key', 'yc52jahgz237tef2egcxcr5sh0kcd8a6', '')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'df');
